...
/// Time spent: 4 hours
/// 
/// Issues: I couldn't get the sf::vector2u to work, even using the email you sent last month, I tried coding it in the cpp but got a lot of errors. 
///			I was also unsure about the other parts of the  sf::2i,2f,3i,3f casting and may have done them incorrectly
/// 
/// 
